...
/*:
 * @target MV MZ
 * @plugindesc v1.01 Enables parallel common events, even during battle.
 ...
 * The above registered common events are disabled.
 */

/*:ja
 * @target MV MZ
 * @plugindesc v1.01 コモンイベントの並列処理を戦闘中も有効にします。
